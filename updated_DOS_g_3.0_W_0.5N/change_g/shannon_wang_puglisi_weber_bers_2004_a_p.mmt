...
[cell]
dot(V) = -(INa.i_Na + INab.i_Nab + INaK.i_NaK + IKr.i_Kr + IKs.i_Ks + Itos.i_tos + Itof.i_tof + IK1.i_K1 + INaCa.i_NaCa + ICl_Ca.i_Cl_Ca + IClb.i_Clb + ICaL.i_CaL + ICab.i_Cab + ICap.i_Cap + IKp.i_Kp + i_Stim + diffusion_current)
    in [mV]

diffusion_current = 0 bind diffusion_current
    in [A/F]
